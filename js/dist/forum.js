...
/***/ "./src/forum/extend/addPostSourceToCommentPost.tsx":
/*!*********************************************************!*\
  !*** ./src/forum/extend/addPostSourceToCommentPost.tsx ***!
  \*********************************************************/
...
/* harmony export */   "default": () => (/* binding */ addSourceToCommentPost)
/* harmony export */ });
...
function addSourceToCommentPost() {
  (flarum_common_models_Post__WEBPACK_IMPORTED_MODULE_3___default().prototype.source) = flarum_common_Model__WEBPACK_IMPORTED_MODULE_2___default().attribute('source');
  (flarum_common_models_Post__WEBPACK_IMPORTED_MODULE_3___default().prototype.sourceData) = flarum_common_Model__WEBPACK_IMPORTED_MODULE_2___default().attribute('source_data');
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_CommentPost__WEBPACK_IMPORTED_MODULE_4___default().prototype), 'headerItems', function (items) {
    var source = this.attrs.post.source();
    var sourceData = this.attrs.post.sourceData();

    if (!source) {
      return;
    }

    var displayText = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('blomstra-conversations-email.forum.post.source');
    var className = 'PostedByEmail';
    var element;
    ...
    if (source === 'blomstra-post-by-mail' && !sourceData) {
      ...
      element = m((flarum_common_components_Tooltip__WEBPACK_IMPORTED_MODULE_5___default()), {
        text: sourceData
      }, m("span", {
        className: className
      }, displayText));
...
/* harmony import */ var flarum_forum_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! flarum/forum/app */ "flarum/forum/app");
/* harmony import */ var flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_app__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _extend_addPostSourceToCommentPost__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./extend/addPostSourceToCommentPost */ "./src/forum/extend/addPostSourceToCommentPost.tsx");


flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('blomstra/conversations', function () {
  (0,_extend_addPostSourceToCommentPost__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
